...
export async function getRandomTypingText(req, res) {
    try {
        ...
        if (!randomText || !randomText.id || !randomText.text || !randomText.difficulty) {
            res.status(404).json({
                error: "No typing texts available. Please contact administrator.",
            });
            return;
...
//# sourceMappingURL=typing_controller.js.map
...
router.post("/typing-game", authenticateToken, scoreController.submitTypingGameScore);
// Get typing game history (protected)
router.get("/typing-game/history", authenticateToken, scoreController.getTypingGameHistory);
